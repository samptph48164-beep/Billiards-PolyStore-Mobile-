...
import com.datn.vpp.sp26.databinding.FragmentProfileBinding
...
import com.datn.vpp.sp26.present.user.activity.favorite.FavoriteProductsActivity
import com.datn.vpp.sp26.present.user.activity.order.history.OrderActivity
import com.datn.vpp.sp26.present.user.activity.setting.SettingActivity
...
class ProfileFragment : BaseFragment<FragmentProfileBinding>() {
    ...
    override fun initViews() {
        ...
        if (SharedPrefCommon.role == AppConst.ROLE_WHOLESALE)
            binding.tvNotiRole.visibleView()
        else binding.tvNotiRole.goneView()
