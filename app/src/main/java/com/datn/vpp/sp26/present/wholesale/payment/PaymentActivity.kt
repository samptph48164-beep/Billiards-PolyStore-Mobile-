package com.datn.vpp.sp26.present.wholesale.payment
...
import com.datn.vpp.sp26.databinding.ActivityPaymentBinding
...
import com.datn.vpp.sp26.present.user.activity.order.confirm.CartConfirmAdapter
import com.datn.vpp.sp26.present.user.activity.order.confirm.ConfirmViewModel
...
class PaymentActivity : BaseActivity<ActivityPaymentBinding>() {
    ...
    override fun getLayoutActivity(): Int = R.layout.activity_payment
    ...
    override fun initViews() {
        ...
        cartConfirmAdapter = CartConfirmAdapter(
            contextParams = this@PaymentActivity,
        ...
        notificationDialog = NotificationDialog(
            context = this,
            onOk = {
                startActivity(Intent(this@PaymentActivity, OrderActivity::class.java))
                finish()
            }
        )
        setData()
                                    ...
                                    AlertDialog.Builder(this@PaymentActivity)
                                        ...
                                        .setPositiveButton(
                                            ...
                                            ZaloPaySDK.getInstance()
                                                .navigateToZaloPayOnStore(this@PaymentActivity)
                                        }
