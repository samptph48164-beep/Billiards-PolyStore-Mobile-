package com.datn.vpp.sp26.domain.usecase.auth
...
class UpdatePhoneNumberAndAddressUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        try {
            when (val response = authRepository.updatePhoneNumberAndAddress(id, req)) {
